...
<body>
    ...
    <div class="bottombar">
        ...
        <a href="logout.php" class="icon-signout-desktop"><img src="assets/images/signout.svg" /></a>
    </div>
            ...
            <div class="postlist-container">
               <?php
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo '<div class="noPosts">No posts sent yet. Click on the &#43; icon to send your first message!</div>';
                }
                ?>
            </div>
        </div>
